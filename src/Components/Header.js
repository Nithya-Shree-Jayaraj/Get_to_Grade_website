   ...
   return (
      <section className='w-full px-0 overflow-hidden lg:px-4 xl:px-16'>
         <header className='flex items-center justify-between h-full gap-6 p-6'>
            ...
            <nav className='justify-center flex-1 hidden w-6/12 px-10 lg:flex'>
               <ul className='flex mt-4 space-x-5 font-bold xl:space-x-10 2xl:space-x-16'>
                  <li><a className='w-1/6 text-yellow-400 border-b-2 border-yellow-400' href="#">Home</a></li>
                  <li><a className='w-1/6 lg:text-sm text-nowrap' href="#">About Us</a></li>
              
                  <li className="relative">
                     <span className="w-1/6 text-sm font-bold">Course</span>
         ...
         {/* Mobile Menu */}
         <div className={` lg:hidden fixed top-0 left-0 w-full h-full bg-white z-30 transition-transform transform ${menuOpen ? 'translate-x-0' : '-translate-x-full'} ease-in-out duration-300`}>
            <div className='p-6'>
