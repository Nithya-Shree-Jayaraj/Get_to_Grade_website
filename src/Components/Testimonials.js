...
//             alt="Our Student"
//           />
//           <h2 className="text-2xl lg:text-7xl md:text-7xl font-bold text-gray-900 relative z-10 lg:bottom-28 lg:-inset-28 lg:-left-[38%] md:bottom-32 md:-inset-48 md:-left-[30%] w-full text-nowrap lg:space-x-10 md:space-x-0 space-x-1 -inset-72 -left-[50%]">
//             What <span className="text-white text-2xl md:text-5xl lg:text-7xl">our Student’s</span> <span>say</span>
//           </h2>
//           <p className='absolute z-10  justify-center items-center w-auto mt-36 text-bold text-xl md:text-2xl lg:text-3xl'>Here's what our students say about their tranformative learning experience:Real Stories, real growth.<br />
//             Discover fisthand the impact our courses had in their lives.</p>
//           <img
//             src={dot}
//             alt={dot}
...
//               <span class="bg-red-500 px-2 py-1 text-white">What our Student’s say</span>
//             </h2>
